...
<div class="site-wrap">
  ...
  <nav class="site-nav">
    ...
    <ul>
      <li ><a href="nikom_all.php">นิคม</a>
      <li ><a href="score.php">เกณฑ์การเป็นเมืองอุตสาหกรรม</a>
      
        <ul>
          <li class="active" ><a href="eco_champion.php">ECO-CHAMPION</a></li>
  ...
  <main>
    ...
    <div class="content-columns">
      ...
      <div class="col">
        <div class="item"><h2>เกณฑ์เบื้องต้น</h2></div>
        <div class="item">1. นโนบายพื้นที่สีเขียว 
            <br> การจัดสรรและบริหารจัดการของพื้นที่นิคมอุตสาหกรรม <h5>< บังคับ > | < แก้ไข > | < ลบ ></h5></div>
        <div class="item">2. ระบบสาธารณูปโภคและสาธารณูปการ
            <br> ประสิทธิภาพของระบบสาธารณูปโภคและสาธารณูปการ <h5>< บังคับ > | < แก้ไข > | < ลบ ></h5></div>
        <div class="item"><h3>+ เพิ่ม</h3></div>
        <div class="item"></div>
        <div class="item"></div>
        <div class="item"></div>
        <div class="item"></div>
      ...
      <div class="col">
        <div class="item"><h2>เกณฑ์คะแนน</h2></div>
        <div class="item">1.การควบคุมมลภาวะทางน้ำ <h5>< คะแนน ></h5></div>
        <div class="item">2.การควบคุมมลภาวะทางอากาศ<h5>< คะแนน ></h5></div>
        <div class="item"><h3>+ เพิ่ม</h3></div>
        <div class="item"></div>
        <div class="item"></div>
        <div class="item"></div>
