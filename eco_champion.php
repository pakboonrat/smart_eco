...
<div class="site-wrap">
  ...
  <main>
    ...
    <div class="content-columns">
      ...
      <div class="col">
        <div class="item"><h2>เกณฑ์บังคับ</h2></div>
      ...
      <div class="col">
        ...
        <div class="item">1.การควบคุมมลภาวะทางน้ำ <h5>< บังคับ > | < แก้ไข > | < ลบ ></h5></div>
        <div class="item">2.การควบคุมมลภาวะทางอากาศ<<h5>< บังคับ > | < แก้ไข > | < ลบ ></h5></div>
        <div class="item"><h3>+ เพิ่ม</h3></div>
        <div class="item"></div>
        <div class="item"></div>
        <div class="item"></div>
