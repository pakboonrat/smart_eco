...
<div class="site-wrap">
  ...
  <main>
    ...
    <header>
      ...
      <h1>ข้อมูลนิคมที่ส่งมาให้ประเมิน <a href="#0" ></a></h1>
      
      <nav class="nav-tabs" id="nav-tabs">
      <a href="nikom_score.php" class="active">
          นิคมที่ส่งเกณฑ์เข้าตรวจ (แบ่งตามระดับ)
          <span>32</span>
        </a>

      
        <a href="nikom_all.php" >
          ประวัติการตรวจคะแนนนิคม
          <span>80</span>
        </a>
    ...
    <div class="content-columns">
      ...
      <div class="col">
        <div class="item"><h1>ECO CHAMPION</h1></div>
        <div class="item">นิคมฯ ดับบลิวเอชเอ ชลบุรี 2  </div>
        <div class="item">นิคมอุตสาหกรรมบ้านบึง</div>
        <div class="item">นิคมอุตสาหกรรมแหลมฉบัง</div>
        <div class="item"></div>
        <div class="item"></div>
        <div class="item"></div>
        <div class="item"></div>
      ...
      <div class="col">
        <div class="item"><h1>ECO-EXCELLENCE</h1></div>
        <div class="item">นิคมอุตสาหกรรมปิ่นทอง</div>
        <div class="item">นิคมอุตสาหกรรมเวลโกรว์</div>
        <div class="item"></div>
        <div class="item"></div>
        <div class="item"></div>
        <div class="item"></div>
      ...
      <div class="col">
        <div class="item"><h1>ECO-WORLD CLASS</h1></div>
        <div class="item">นิคมอุตสาหกรรมราชบุรี</div>
        <div class="item"></div>
        <div class="item"></div>
        <div class="item"></div>
        <div class="item"></div>
