...
<div class="site-wrap">
  ...
  <main>
    <header>
      ...
      <h1>สถานะการส่งพิจารณา : &nbsp;<?php $userdata = new DB_con();
								   $result = $userdata->sel_username($_GET['user_id']);
								   $row = mysqli_fetch_array($result);
								   echo $row['firstname'];?></h1>
								...
								<thead>
								  ...
								  <tr>
									...
									<?php 	$fetchdata = new DB_con();
											$sql = $fetchdata->basic_report($_GET['user_id']);
									    ...
									    <table width="100%" border="0" cellspacing="0" cellpadding="0">
										  <tbody>
											  <?php	$fetchdata2 = new DB_con();
													$sql2 = $fetchdata2->basic_report_tran($row['level_id'],$_GET['user_id']);
													//echo $row['level_id'];
													//echo $_GET['user_id'];
										    ...
										    <tr>
											  ...
											  <td width="13%" height="30" align="center" valign="top">
									...
									<div class="item"> 
									<?php 	$fetchdata = new DB_con();
										$sql = $fetchdata->control_report($_GET['user_id']);
										$score_count = 0;
										...
										while($row = mysqli_fetch_array($sql)) {;
											...
											echo "<b><font style='color:2874A6;'>เกณฑ์บังคับ</font></b><br>"; 
													...
													//echo $row['level_id'];
													$result4 = $fetchdata4->select_uadd_scoredes($row['level_id'],$_GET['user_id']);
													$num4 = mysqli_fetch_array($result4);
													$result2 = $fetchdata3->select_scoredes($row['level_id'],$_GET['user_id']);
											...
											<?php	$fetchdata2 = new DB_con();
													...
													$sql2 = $fetchdata2->basic_report_tran($row['level_id'],$_GET['user_id']);
													$sql12 = $fetchdata12->count_basic_report_tran($row['level_id'],$_GET['user_id']);
											  ...
											  ?>
												<tr>
												  <td width="87%" height="30"><font style="font-size:14px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row2['list_label'];?></font></td>
												  <td width="13%" height="30" align="center" valign="top"><?php if ($row2['status']=="save") {echo "<span class='alert-warning'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;บันทึก&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>";} 
													elseif ($row2['status']=="consider") {echo "<span class='alert-primary'>&nbsp;รอพิจารณา&nbsp;</span>";} 
													elseif ($row2['status']=="pass") {echo "<span class='alert-success'>ผ่านพิจารณา</span>";}
													elseif ($row2['status']=="reject") {echo "<span class='alert-danger'>&nbsp;&nbsp;&nbsp;ไม่อนุมัติ&nbsp;&nbsp;&nbsp;</span>";}
													else {echo "-";}
