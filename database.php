...
<div class="site-wrap">
  ...
  <div class="content-columns">
	...
	<?php		
			...
			$user_id = $_SESSION['id'];
            $sql1 = $fetchdata1->selectfiledb($user_id);
			//$irow_count = 1;
	...
	<div class="item2">
	  <table width="95%" border="0" cellspacing="1" cellpadding="1">
		...
		<tr>
		  ...
		  <td><a href="database.php?edit=delete&id=<?php echo $row_userfile['id']; ?>" onClick="return confirm('คุณยืนยันที่จะลบข้อมูล?');"><img src="images/delete.gif" width="30" height="26"><font style="font-size:16px;">&nbsp;ลบข้อมูล</a></font></td>
		</tr>
	  </table>
	</div>
	<?php  }; ?>
